...
import de.neemann.digiblock.analyse.DetermineJKStateMachine;
import de.neemann.digiblock.analyse.ModelAnalyserInfo;
import de.neemann.digiblock.analyse.expression.*;
import de.neemann.digiblock.analyse.expression.Not;
import de.neemann.digiblock.builder.BuilderException;
import de.neemann.digiblock.builder.BuilderInterface;
import de.neemann.digiblock.core.basic.*;
import de.neemann.digiblock.core.element.Keys;
import de.neemann.digiblock.core.element.Rotation;
...
import de.neemann.digiblock.core.io.Probe;
...
import static de.neemann.digiblock.analyse.expression.Variable.isVar;
import static de.neemann.digiblock.analyse.expression.Variable.isVarOrNotVar;
...
public class CircuitBuilder implements BuilderInterface<CircuitBuilder> {
    ...
    private Fragment createBasicFragment(Expression expression) throws BuilderException {
        if (expression instanceof Operation) {
            ...
            return new FragmentExpression(createBasicFragment(n.getExpression()), new FragmentVisualElement(de.neemann.digiblock.core.basic.Not.DESCRIPTION, shapeFactory));
    ...
    private void createInputBus(Collection<Variable> inputs, Circuit circuit) {
        ...
        for (Variable v : inputs) {
            ...
            if (isNotNeeded(v.getIdentifier())) {
                visualElement = new VisualElement(de.neemann.digiblock.core.basic.Not.DESCRIPTION.getName()).setShapeFactory(shapeFactory);
                visualElement.getElementAttributes()
                        .set(Keys.ROTATE, new Rotation(3));
