...
import de.neemann.digiblock.hdl.model2.HDLNet;
 ...
 * Takes the circuit, generates the hdl model ({@link de.neemann.digiblock.hdl.model2.HDLModel}.
 * After that the clocks are handled for the specific board.
 * And after that the {@link de.neemann.digiblock.hdl.vhdl2.VHDLCreator} is used to write the model
