...
import de.neemann.digiblock.draw.shapes.*;
...
import static de.neemann.digiblock.gui.components.CircuitComponent.raster;
...
public class VisualElement implements Drawable, Movable, AttributeListener {
     ...
     * The name of the element is the name which is given to the Library to get the {@link de.neemann.digiblock.core.element.ElementTypeDescription}
     *
