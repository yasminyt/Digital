...
import de.neemann.digiblock.core.arithmetic.BarrelShifterMode;
import de.neemann.digiblock.core.arithmetic.LeftRightFormat;
...
import de.neemann.digiblock.core.memory.DataFieldConverter;
import de.neemann.digiblock.core.memory.rom.ROMManger;
...
import de.neemann.digiblock.undo.Copyable;
 ...
 * Such a Circuit instance is used by the {@link de.neemann.digiblock.draw.model.ModelCreator} to
 * create a runnable model representation (see {@link de.neemann.digiblock.core.Model}).
