...
import de.neemann.digiblock.core.flipflops.*;
import de.neemann.digiblock.core.io.*;
import de.neemann.digiblock.core.memory.*;
import de.neemann.digiblock.core.pld.DiodeBackward;
import de.neemann.digiblock.core.pld.DiodeForward;
import de.neemann.digiblock.core.pld.PullDown;
import de.neemann.digiblock.core.pld.PullUp;
import de.neemann.digiblock.core.switching.*;
import de.neemann.digiblock.core.wiring.*;
...
import de.neemann.digiblock.gui.components.graphics.GraphicCard;
...
public class ElementLibrary implements Iterable<ElementLibrary.ElementContainer>, LibraryInterface {
    ...
    public static File getLibPath() {
        ...
        if (path.endsWith("/target/Digiblock.jar"))
            return new File(path.substring(0, path.length() - 21) + "/src/main/dig/lib");
        if (path.endsWith("Digiblock.jar"))
            return new File(path.substring(0, path.length() - 14) + "/examples/lib");
